...
const _sfc_main$6 = {};
const _hoisted_1$6 = { class: "app-shell" };
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render]]);
...
const useLauncherStore = /* @__PURE__ */ defineStore("launcher", {
  state: () => ({
    config: null,
    installations: [],
    serverStatus: null,
...
const _hoisted_1$5 = { class: "splash" };
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      try {
        ...
        await auth.refresh();
        await router2.replace(auth.isAuthenticated ? "/home" : "/login");
      } catch (error) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1$5, [..._cache[0] || (_cache[0] = [
        createBaseVNode("h1", null, "MzzPlork", -1),
        createBaseVNode("p", null, "Starting up…", -1)
      ])]);
    };
  }
});
const Splash = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-1686e5e9"]]);
const _hoisted_1$4 = { class: "login" };
const _hoisted_2$4 = {
  key: 0,
  class: "error",
  role: "alert"
  ...
  setup(__props) {
    ...
    async function onSubmit() {
      try {
        ...
        await router2.replace("/home");
      } catch {
      }
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1$4, [
        _cache[4] || (_cache[4] = createBaseVNode("h1", null, "MzzPlork", -1)),
        createBaseVNode("form", {
          onSubmit: withModifiers(onSubmit, ["prevent"])
        }, [
          createBaseVNode("label", null, [
            _cache[2] || (_cache[2] = createTextVNode(" Username ", -1)),
          ...
          createBaseVNode("label", null, [
            _cache[3] || (_cache[3] = createTextVNode(" Password ", -1)),
            withDirectives(createBaseVNode("input", {
          ...
          unref(auth).error ? (openBlock(), createElementBlock("p", _hoisted_2$4, toDisplayString(unref(auth).error), 1)) : createCommentVNode("", true),
          createBaseVNode("button", {
            type: "submit",
            disabled: unref(auth).loading
          }, toDisplayString(unref(auth).loading ? "Signing in…" : "Sign in"), 9, _hoisted_3$3)
        ], 32)
      ]);
    };
  }
});
const Login = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-2892f9ee"]]);
const _hoisted_1$3 = { class: "home" };
const _hoisted_2$3 = { class: "status" };
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const launcher = useLauncherStore();
    onMounted(async () => {
      await launcher.refreshServerStatus().catch(() => void 0);
    });
    async function onCheckForUpdates() {
      await router2.push("/updating");
    }
    async function onLogout() {
      await auth.logout();
      await router2.replace("/login");
    }
    return (_ctx, _cache) => {
      const _component_router_link = resolveComponent("router-link");
      return openBlock(), createElementBlock("main", _hoisted_1$3, [
        createBaseVNode("header", null, [
          _cache[0] || (_cache[0] = createBaseVNode("h1", null, "MzzPlork", -1)),
          createBaseVNode("span", null, "Signed in as " + toDisplayString(unref(auth).username), 1)
        ]),
        createBaseVNode("section", _hoisted_2$3, [
          unref(launcher).serverStatus ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createBaseVNode("strong", null, toDisplayString(unref(launcher).serverStatus.online ? "Server online" : "Server offline"), 1),
            unref(launcher).serverStatus.online ? (openBlock(), createElementBlock("span", _hoisted_3$2, toDisplayString(unref(launcher).serverStatus.players) + " / " + toDisplayString(unref(launcher).serverStatus.maxPlayers) + " players ", 1)) : createCommentVNode("", true)
          ], 64)) : (openBlock(), createElementBlock("span", _hoisted_4$1, "Checking server status…"))
        ]),
...
const Home = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ea8dab3a"]]);
const _hoisted_1$2 = { class: "updating" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1$2, [
        _cache[0] || (_cache[0] = createBaseVNode("h1", null, "Updating…", -1)),
        unref(launcher).updateProgress ? (openBlock(), createElementBlock("p", _hoisted_2$2, [
          createTextVNode(toDisplayString(unref(launcher).updateProgress.status) + " ", 1),
          unref(launcher).updateProgress.file ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createTextVNode(" — " + toDisplayString(unref(launcher).updateProgress.file), 1)
          ], 64)) : createCommentVNode("", true),
          unref(launcher).updateProgress.filesTotal ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            createTextVNode(" (" + toDisplayString(unref(launcher).updateProgress.filesCompleted) + "/" + toDisplayString(unref(launcher).updateProgress.filesTotal) + " files) ", 1)
          ], 64)) : createCommentVNode("", true)
        ])) : (openBlock(), createElementBlock("p", _hoisted_3$1, "Checking for updates…"))
      ]);
    };
  }
});
const Updating = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-672573c5"]]);
const _hoisted_1$1 = { class: "settings" };
const _hoisted_2$1 = { key: 0 };
const _hoisted_3 = ["value"];
const _hoisted_4 = { class: "checkbox" };
const _hoisted_5 = ["checked"];
const _hoisted_6 = { class: "game-path" };
const _hoisted_7 = { class: "manual" };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const validationMessage = /* @__PURE__ */ ref(null);
    onMounted(async () => {
      await launcher.loadConfig();
    });
    ...
    async function onValidateManualPath() {
      const result = await launcher.validateGamePath(manualPath.value);
      validationMessage.value = result ? `Found GTA V at ${result.installPath}` : "GTA5.exe was not found at that path";
    }
    async function onChannelChange(event) {
      const channel = event.target.value;
      await launcher.updateConfig({ channel });
    }
    async function onAutoUpdateToggle(event) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1$1, [
        createBaseVNode("header", null, [
          _cache[2] || (_cache[2] = createBaseVNode("h1", null, "Settings", -1)),
          createBaseVNode("button", {
            type: "button",
            onClick: _cache[0] || (_cache[0] = ($event) => unref(router2).back())
          }, "Back")
        ]),
        unref(launcher).config ? (openBlock(), createElementBlock("section", _hoisted_2$1, [
          createBaseVNode("label", null, [
            _cache[4] || (_cache[4] = createTextVNode(" Channel ", -1)),
            createBaseVNode("select", {
              value: unref(launcher).config.channel,
              onChange: onChannelChange
            }, [..._cache[3] || (_cache[3] = [
              createBaseVNode("option", { value: "stable" }, "stable", -1),
              createBaseVNode("option", { value: "beta" }, "beta", -1),
              createBaseVNode("option", { value: "dev" }, "dev", -1)
            ])], 40, _hoisted_3)
          ]),
          createBaseVNode("label", _hoisted_4, [
            createBaseVNode("input", {
              type: "checkbox",
              checked: unref(launcher).config.autoUpdate,
              onChange: onAutoUpdateToggle
            }, null, 40, _hoisted_5),
            _cache[5] || (_cache[5] = createTextVNode(" Automatically update on start ", -1))
          ]),
          createBaseVNode("div", _hoisted_6, [
            createBaseVNode("p", null, "Game path: " + toDisplayString(unref(launcher).config.gamePath || "not set"), 1),
            createBaseVNode("button", {
              type: "button",
              onClick: onDetect
            }, "Auto-detect"),
            createBaseVNode("div", _hoisted_7, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => manualPath.value = $event),
                type: "text",
                placeholder: "Manual GTA V install path"
              }, null, 512), [
            ...
            validationMessage.value ? (openBlock(), createElementBlock("p", _hoisted_8, toDisplayString(validationMessage.value), 1)) : createCommentVNode("", true)
          ])
...
const Settings = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ca394a9f"]]);
const _hoisted_1 = { class: "error-view" };
const _hoisted_2 = { role: "alert" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "Error",
  setup(__props) {
    const route = useRoute();
    const router2 = useRouter();
    const message = computed(() => route.query.message ?? "An unexpected error occurred.");
    async function onRetry() {
      await router2.replace("/");
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1, [
        _cache[0] || (_cache[0] = createBaseVNode("h1", null, "Something went wrong", -1)),
        createBaseVNode("p", _hoisted_2, toDisplayString(message.value), 1),
        createBaseVNode("button", {
          type: "button",
          onClick: onRetry
        }, "Retry")
...
const ErrorView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b3218650"]]);
